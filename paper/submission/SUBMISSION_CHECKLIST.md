...
- supplementary.pdf / supplementary.tex — supplementary material (S0–S4)
...
- Keywords: remaining useful life; prediction intervals; uncertainty quantification; sensor degradation; data leakage; conformal prediction; maintenance decisions; C-MAPSS
- Corresponding author e-mail: jefflsxy@lsu.edu.cn  (verify character by character)
- Funding: none.  Conflicts: none.  Human/animal subjects: not applicable.
- Data availability: repository URL and tag as above; C-MAPSS from NASA PCoE.
- Supplementary material: upload supplementary.pdf as "Supplementary Material".
