...
mapping = {
 'clean': [
   ...
   ('intermediate/table1_leak_audit/table1_2x2_per_seed.json', 'table1_2x2_per_seed.json'),
   ('intermediate/table1_leak_audit/table1_2x2_summary.json', 'table1_2x2_summary.json'),
   ...
   ('intermediate/calibration_and_controls/table2_clean_full.json', 'table2_clean_full.json'),
   ('intermediate/calibration_and_controls/fair_calibration_main_table.json', 'fair_calibration_main_table.json'),
   ('intermediate/calibration_and_controls/fair_calibration_sigma_fixed.json', 'fair_calibration_sigma_fixed.json'),
   ('intermediate/calibration_and_controls/interval_score_wis_clean.json', 'interval_score_wis_clean.json'),
   ('intermediate/calibration_and_controls/protocol_2x2_quadrant4_testselect_fitonlyscaler.json', 'protocol_2x2_quadrant4_testselect_fitonlyscaler.json'),
 ...
 'degradation': [
   ...
   ('intermediate/calibration_and_controls/drift_controls.json', 'drift_controls.json'),
   ('intermediate/attribution_and_decision/D1_fixed_endpoint_shuffle.json', 'drift_fixed_endpoint_shuffle_control.json'),
   ('intermediate/attribution_and_decision/D3_refined_grid_transformer_fd001_ensemble.json', 'threshold_refined_grid_transformer_fd001_ensemble.json'),
   ('intermediate/partition_and_rul_correction/threshold_960_refinement.json', 'threshold_crossover_refinement.json'),
   ('intermediate/threshold_leftside_extension/threshold_960_leftside_extension.json', 'threshold_crossover_leftside_extension.json'),
 ],
 'attribution': [
   ('intermediate/calibration_and_controls/frozen_decomposition_2x2.json', 'frozen_output_decomposition_2x2_nearest_grid.json'),
   ('intermediate/attribution_and_decision/B_attribution_raw_per_seed.json', 'attribution_raw_per_seed_nearest_grid.json'),
   ('intermediate/attribution_and_decision/G_transformer_exact_interp_attribution.json', 'attribution_transformer_exact_interp.json'),
   ('intermediate/attribution_and_decision/H_lstm_exact_interp_attribution.json', 'attribution_lstm_exact_interp.json'),
   ('intermediate/attribution_and_decision/bootstrap_absmu_minus_abssigma.json', 'attribution_bootstrap_order_averaged_nearest_grid.json'),
   ('intermediate/attribution_and_decision/bootstrap_by_order_exact_interp.json', 'attribution_bootstrap_by_order_exact_interp.json'),
 ],
 'decision': [
   ('intermediate/calibration_and_controls/maintenance_decision.json', 'maintenance_decision_two_sided.json'),
   ('intermediate/attribution_and_decision/C_maintenance_full_onesided.json', 'maintenance_decision_one_sided.json'),
   ('intermediate/partition_and_rul_correction/C_maintenance_rul_corrected.json', 'maintenance_decision_rul_corrected_v1.json'),
   ('intermediate/partition_and_rul_correction/C_maintenance_rul_corrected_v2.json', 'maintenance_decision_rul_corrected_v2.json'),
   ('intermediate/partition_and_rul_correction/exact_match_log.json', 'maintenance_decision_rul_correction_exact_match_check.json'),
 ],
 'latency': [
   ('intermediate/calibration_and_controls/latency_redesign_run1.json', 'lstm_latency.json'),
 ...
 'seeds': [
   ('intermediate/samesplit/samesplit_ensemble.json', 'samesplit_ensemble_control.json'),
   ('intermediate/attribution_and_decision/A2_fd004_msweep_IS.json', 'ensemble_size_sweep_fd004_interval_score.json'),
   ('intermediate/attribution_and_decision/E_ensemble_independent_replication.json', 'ensemble_independent_replication.json'),
 ],
 'diagnostics': [
   ('intermediate/protocol_diagnostics/A1_perturbation_target_diagnostic.json', 'A1_perturbation_target_diagnostic.json'),
   ('intermediate/protocol_diagnostics/A2_target_alignment_diagnostic.json', 'A2_target_alignment_diagnostic.json'),
 ],
}
